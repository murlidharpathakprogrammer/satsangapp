                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Title(color: Colors.yellow, child: Text("वार्षिक महोत्सव", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)),
                    ),
                    Container(
                      height: 300,
                      child: const MahotsavaWidgetList(),
                    ),
                  ],
                ),
              ),
